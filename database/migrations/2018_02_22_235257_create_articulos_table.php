...
class CreateArticulosTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('articulos')->insert(array('id'=>'18','idcategoria'=>'7','codigo'=>'BB1','nombre'=>'GERBER SET PEINE/CEPILLO PARA BEBES','precio_venta'=>'16.50','stock'=>'Kit de limpieza para el cabello de bebe','descripcion'=>'','condicion'=>'1'));
        DB::table('articulos')->insert(array('id'=>'19','idcategoria'=>'8','codigo'=>'ABB1','nombre'=>'EVENFLO BIBERON CLASSIC FLUJO MEDIO 4OZ ','precio_venta'=>'12.00','stock'=>'50','descripcion'=>'Biberon de 4 onzas para bebe.','condicion'=>'1'));
        DB::table('articulos')->insert(array('id'=>'20','idcategoria'=>'9','codigo'=>'CBB1','nombre'=>'LIMPIADOR NASAL Y DE OJOS BEBES','precio_venta'=>'18.25','stock'=>'45','descripcion'=>'Kit de limpieza personal para bebe.','condicion'=>'1'));
        DB::table('articulos')->insert(array('id'=>'21','idcategoria'=>'23','codigo'=>'P1','nombre'=>'PRUDENCE CONDONES SABOR Y AROMA MENTA 3UNI','precio_venta'=>'12.25','stock'=>'300','descripcion'=>'Condón masculino de hule látex, lubricado con silicón','condicion'=>'1'));
        DB::table('articulos')->insert(array('id'=>'22','idcategoria'=>'23','codigo'=>'P2','nombre'=>'PRUDENCE CONDONES ANILLOS Y PUNTOS 3UNI','precio_venta'=>'13.50','stock'=>'200','descripcion'=>'Condón masculino de hule látex texturizado con anillos y puntos, lubricado con silicón','condicion'=>'1'));
        DB::table('articulos')->insert(array('id'=>'23','idcategoria'=>'23','codigo'=>'P3','nombre'=>'PRUDENCE CONDONES ANILLO TERREMOTO','precio_venta'=>'44.75','stock'=>'300','descripcion'=>'Disfruta con tu pareja del placer prolongado que te brindan las constantes vibraciones de Prudence Terremoto, que estimula de forma directa las zonas sensibles de cada uno, haciendo una experiencia realmente vibrante.','condicion'=>'1'));
        DB::table('articulos')->insert(array('id'=>'24','idcategoria'=>'15','codigo'=>'CB1','nombre'=>'ORAL B ENJUAGUE 473ML 3D WHITE','precio_venta'=>'34.75','stock'=>'100','descripcion'=>'Enjuague bucal Oral B. Blanqueador sin alcohol, ayuda a eliminar bacterias y a combatir el mal aliento.','condicion'=>'1'));
        DB::table('articulos')->insert(array('id'=>'25','idcategoria'=>'15','codigo'=>'CB2','nombre'=>'Crema dental Colgate Luminous White 125','precio_venta'=>'35.00','stock'=>'100','descripcion'=>'Complementa la limpieza de tu boca utilizando la pasta dental Colgate luminous white y disfruta de dientes más blancos en poco tiempo. Su presentación econopack de 125 ml te ayuda a combatir los gérmenes de la caries y te brinda una salud correcta en tu boca.','condicion'=>'1'));
        DB::table('articulos')->insert(array('id'=>'26','idcategoria'=>'15','codigo'=>'CB3','nombre'=>'ORAL B HILO DENTAL ESSENTIAL 50M NORMAL','precio_venta'=>'29.00','stock'=>'90','descripcion'=>'s un artículo de limpieza que te ayuda a prevenir gingivitis y a remover efectivamente la placa bacteriana, deslizándose de manera fácil y rápida entre tus dientes blancos.','condicion'=>'1'));
        DB::table('articulos')->insert(array('id'=>'27','idcategoria'=>'17','codigo'=>'CC1','nombre'=>'GOTAS DE SEDA PARA CABELLO 75 ML','precio_venta'=>'22.50','stock'=>'110','descripcion'=>'Sílica para cabello Moss con extracto de almendras fresa 75 ml','condicion'=>'1'));
        DB::table('articulos')->insert(array('id'=>'28','idcategoria'=>'17','codigo'=>'CC2','nombre'=>'HERBAL ESSEN ESPUMA CABELLO RIZO 227G','precio_venta'=>'31.00','stock'=>'130','descripcion'=>'La forma más sencilla de peinarte sin complicaciones, acomodando cada cabello en tú peinado diario, de la manera que tú prefieras y luciendo un aspecto húmedo con aroma frutal que te encantará y te hará lucir increíble.','condicion'=>'1'));
        DB::table('articulos')->insert(array('id'=>'29','idcategoria'=>'16','codigo'=>'CP1','nombre'=>'PONDS CREMA FACIAL CLARANT B3 PIEL NORMAL A GRASA 50G','precio_venta'=>'18.50','stock'=>'78','descripcion'=>'Previene la aparición de manchas en la piel con la Ponds Clarant B3 con FPS 30','condicion'=>'1'));
        DB::table('articulos')->insert(array('id'=>'30','idcategoria'=>'16','codigo'=>'CP2','nombre'=>'Bandas depilatorias corporales Veet Easy Grip cera fría piel sensible 12 pzas','precio_venta'=>'108.05','stock'=>'95','descripcion'=>'Las bandas de cera Veet, te dan un toque de suavidad que dura hasta por cuatro semanas. Cada una de las bandas está especialmente formulada con una mezcla de vitamina E y aceite de almendras que deja tu piel humectada y delicadamente perfumada.','condicion'=>'1'));
