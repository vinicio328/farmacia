...
class CreateCategoriasTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('categorias')->insert(array('id'=>'2','nombre'=>'Analgésicos', 'descripcion'=>'pastiilas,inyeciones, pomadas'));
        DB::table('categorias')->insert(array('id'=>'3','nombre'=>'Antibióticos', 'descripcion'=>'oral,inyectado,untado'));
        DB::table('categorias')->insert(array('id'=>'4','nombre'=>'Aparato Cardiovascular', 'descripcion'=>'Articulos del corazon'));
        DB::table('categorias')->insert(array('id'=>'5','nombre'=>'Aparato Respiratorio', 'descripcion'=>'Oxigeno, mascaras'));
        DB::table('categorias')->insert(array('id'=>'6','nombre'=>'Primeros Auxilios', 'descripcion'=>'Insumos de primeros auxilios'));
        ...
        DB::table('categorias')->insert(array('id'=>'23','nombre'=>'Preservativos', 'descripcion'=>'a'));
        DB::table('categorias')->insert(array('id'=>'24','nombre'=>'Pruebas de Embarazo', 'descripcion'=>'b'));
